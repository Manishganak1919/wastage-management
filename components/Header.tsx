...
import { createUser, getUnreadNotification, markNotificationAsRead, getUserByemail, getUserBalance } from "@/utils/db/actions"
      ...
      <div className="flex items-center justify-between px-4 py-2">
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            <Leaf className="h-6 w-6 md:h-8 md:w-8 text-orange-500 mr-1 md:mr-2" />
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">Waste <span className="text-orange-500">Pro</span></span>
              <span className="text-[8px] md:text-[10px] text-gray-500 -mt-1">24 hr Services</span>
            </div>
          </Link>
        </div>
        {!isMobile && (
